(function () {
	...
	Colorpicker.prototype = {
		init(opt) {
			let { el, initColor = "rgb(255,0,0)", allMode = ['hex', 'rgb'], color = '',customTopOffset= 0,customLeftOffset= 0 } = opt;
			...
			util.css(div, {
				...
				"z-index": 2,
				"display": 'none',
				"left": left +customLeftOffset+ "px",
				"top": top + this.bindElem.offsetHeight+customTopOffset + "px"
			});
